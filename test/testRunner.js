...
import {getNestedValue} from '../runner';
import {getNestedValueDeclarative} from '../runner';
...
describe('getNestedValueDeclarative2()', () => {
    it('should return undefined for undefined objects', () =>
    ...
    it('should not accept to get empty property names', () =>
        assert.throws(() => getNestedValueDeclarative({}, ''))
    );
});
